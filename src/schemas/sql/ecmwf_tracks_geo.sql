...
DROP TABLE IF EXISTS storms.ecmwf_tracks_geo_hannah;
...
CREATE TABLE IF NOT EXISTS storms.ecmwf_tracks_geo_hannah(
    ...
    CONSTRAINT ecmwf_tracks_geo_hannah_unique UNIQUE (forecast_id, valid_time, issued_time, geometry, wind_speed, pressure, leadtime, basin, number),
