-- ============================================================================
-- NHC forecast wind buffer population exposure
-- ============================================================================
-- One row per (atcf_id, issued_time, wind_speed_kt, admin_level, pcode):
-- population exposed within that admin unit to the given forecast wind buffer.
--
...
--
-- Populated by running: python run_pipeline.py nhc-track-exp
