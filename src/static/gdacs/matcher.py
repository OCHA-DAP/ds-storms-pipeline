...
This is the one expensive step in the lookup build. Called once per
country by ``scripts/build_canonical_lookup.py``; the whole basin
takes ~minutes on a laptop.
"""
